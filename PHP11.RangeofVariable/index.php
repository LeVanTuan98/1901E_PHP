...
<body>
    ...
    <pre>
        Biến cục bộ: Chỉ có ảnh hưởng và chỉ được sử dụng trong không gian nhất định
        Biến toàn cục: Có ảnh hưởng và có thể sử dụng ở mọi nơi
        Nếu tên biến bị trùng thì nếu sử dụng ngoài hàm thì PHP sẽ lấy giá trị cuả biến toàn cục
